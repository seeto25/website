export const translations = {
  en: {
    ...
    features: {
      ...
      noCar: {
        ...
        description: 'Students and non-car owners can purchase credits to participate. Everyone\'s included in the sustainable mobility solution.'
      }
    },
    howItWorks: {
      title: 'How It Works',
  ...
  de: {
    ...
    hero: {
      ...
      title: 'Share Fahrten.\nSave Kosten.\nSave Planet.',
      description: 'Seeto revolutioniert Fahrgemeinschaften mit einem innovativen Punkte System. Fahrt zusammen, sammelt Credits (Punkte) und macht jede Fahrt wertvoll für euer Team, Sportverein oder eure Organisation. Kein zusätzliches Bezahlen, einfach zusammen fahren.',
